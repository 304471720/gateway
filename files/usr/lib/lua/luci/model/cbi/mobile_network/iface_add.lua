...
$Id: iface_add.lua 9386 2012-10-13 10:08:38Z jow $
...
m.redirect = luci.dispatcher.build_url("mobile/network/network")
m.reset = false
...
function newproto.write(self, section, value)
	...
	if name and #name > 0 then
		...
		luci.http.redirect(luci.dispatcher.build_url("mobile/network/network", name))
	end
end
