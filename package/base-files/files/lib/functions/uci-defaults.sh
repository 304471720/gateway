...
set network.wifi.ifname='$ifname'
set network.wifi.force_link=1
set network.wifi.type='bridge'
set network.wifi.proto='static'
set network.wifi.ipaddr='192.168.19.1'
set network.wifi.netmask='255.255.255.0'
set network.wifi.ip6assign='60'
EOF
}
